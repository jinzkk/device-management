...
## 남은 작업 (12단계: 폴리싱)
1. 로딩 상태 UI (Skeleton, Spinner)
2. 에러 바운더리 / 404 / 에러 페이지
3. 모바일 반응형 테이블 레이아웃 개선
4. 토스트 알림 세부 조정
5. QR 코드 인쇄 시 `@media print` CSS 최적화
6. 장비 사진 업로드 (Supabase Storage 연동)
